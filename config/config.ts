...
export const CREATE2_SALT = "0x7ca392fef4d64c717e8251af66db8361674f99ec878f738bf72f4a9e6074bac7" as const;

export default {
    // Default Hardhat network (in-process EDR simulation).
    default: {
        chainId: 31337,
    ...
    // External Hardhat node (`pnpm hardhat node`), used for integration tests.
    localhost: {
        chainId: 31337,
        initialOwner: "0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266", // Hardhat Account #0
        kmsPublicKey: "0x026f0005c5c3807e69dcbe52a97ca55aa26c8655999b5a81f5098666cd7dd5d1f6",
